...
**Agent working in the terminal — drafting the SRS and self-correcting rule 
violations before writing anything to Confluence:**

![Terminal running ba-agent for SRS creation](screenshots/02-terminal-create-SRS.png)

**Fragment of the published SRS in Confluence — attribute breakdown for a 
...
**Agent working in the terminal — drafting the user story with AC and 
capturing the referenced screenshot before publishing to Jira:**

![Terminal running create_US](screenshots/04-terminal-create-US.png)

**Published Jira story with structured Gherkin AC and inline screenshot:**
...
connector arrows following the layout algorithm defined in `ui-flow-rules.md`:**
