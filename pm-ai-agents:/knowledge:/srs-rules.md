...
- Keep consistency in wording. E.g. "I want to see a “Jinni” button in the header of the Skills Repo page that takes me to my Djinni dashboard" (here "Djinni dashboard" is a clickable link that leads to https://djinni.co/my/dashboard/). Since Djinni dashboard has already been mentioned, then there's no need in reprasing it in the next sentence like - "Then the browser navigates to https://djinni.co/my/dashboard/". It should be "Then the browser navigates to Djinni dashboard" (here "Djinni dashboard" is a clickable link that leads to https://djinni.co/my/dashboard/).  
